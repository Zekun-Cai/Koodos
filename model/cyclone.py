...
data_dim = SETTING['Cyclone']['data_dim']
gene_dim = SETTING['Cyclone']['gene_dim']
embed_dim = SETTING['Cyclone']['embed_dim']
n_train = SETTING['Cyclone']['n_train']
ode_method = SETTING['Cyclone']['ode_method']
rk_step = SETTING['Cyclone']['rk_step']

# Same parts of the predictive model for each domain
